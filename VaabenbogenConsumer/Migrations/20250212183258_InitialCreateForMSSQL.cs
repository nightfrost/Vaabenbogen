        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JaegerId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fabrikant = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Ladefunktion = table.Column<int>(type: "int", nullable: true),
                    LadefunktionFritekst = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Loebenummer = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    Updated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsUdskrevet = table.Column<bool>(type: "bit", nullable: true),
                    Udskrevet = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UdskrevetTilVirksomhedId = table.Column<int>(type: "int", nullable: true),
                    UdskrevetTilJaegerId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
